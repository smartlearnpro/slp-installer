@extends('smartlearnpro.installer.layout')
...
<div class="section-wrap-body">
    ...
    <div class="primary-form">
      <form action="{{ route('SlpInstaller::final') }}" method="POST">
        @csrf
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="AppName" name="app_name" value="{{ $_ENV['APP_NAME'] }}" placeholder="SlpInstaller" />
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
        ...
        <div class="row">
          <div class="col-6">
              <a href="{{ route('SlpInstaller::pre-install') }}" class="primary-btn">Close</a>
          </div>
          <div class="col-6">
