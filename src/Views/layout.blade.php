...
<head>
    ...
    <title>@yield('title') | SmartLearnPro-Installer </title>
    <link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('smartlearnprofiles/assets/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('smartlearnprofiles/assets/style.css') }}">
</head>
<body>
    @yield('preloader')
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    <div class="breadcrumb-text">
                        ...
                        <h2>SMARTLEARNPRO - Learning Management System</h2>
            ...
            <div class="section-wrap">
                <div class="section-wrap-header">
                    <div class="progres-stype">
                        <div class="single-stype {{ Route::is('SlpInstaller::pre-install') ? 'active' : 'finished' }}">
                            <span>Pre-Installation</span>
                        </div>
                        <div class="single-stype {{ Route::is('SlpInstaller::pre-install') ? '' : 'active' }}">
